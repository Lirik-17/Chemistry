...
cbi = function (p, i_exp)
    ...
    png(plt_all, string("./case2/figs/i_exp_", i_exp))
    return false
end
...
cb = function (p, loss_train, loss_val)
    ...
    if iter % n_plot == 0
        ...
        png(plt_loss, "./case2/figs/loss")

        @save "./case2/checkpoint/mymodel.bson" p opt l_loss_train l_loss_val iter;
    end
    iter += 1;
end
...
if is_restart
    @load "./case2/checkpoint/mymodel.bson" p opt l_loss_train l_loss_val iter;
    iter += 1;
end
